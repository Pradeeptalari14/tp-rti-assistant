# 📝 RTI Query Assistant for Indian Citizens

> Form builder draft writing RTI requests. Exports formatted files and updates users via SMS.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rti-assistant/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rti-assistant.git
cd tp-rti-assistant
```
...
```bash
kubectl port-forward deployment/tp-rti-assistant 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── rti_assistant.py     # Main configuration file
```
...
---
*Generated by [RTI Query Assistant for Indian Citizens Studio](https://pradeeptalari14.github.io/portfolio/tools/rti-assistant/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
